...
LINK_ENTITY_TO_CLASS( weapon_ecrowbar, CWeaponStunStick );
PRECACHE_WEAPON_REGISTER( weapon_ecrowbar );
...
{
	return 300.0f; //im gonna cum because it was SO FUCKING SMOOTH!!
	//INSTA KILL FUCKING CROWBAR AND ITS ELECTRIC IT ELECTROCUTES YOU LETS FUCKING GOO IM GONAN CUM!!!!!!!
}
