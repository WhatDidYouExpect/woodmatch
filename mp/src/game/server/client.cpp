...
static ConCommand god("snakez", CC_God_f, "Toggle. Player becomes invulnerable.", FCVAR_CHEAT );
...
void CC_Notarget_f (void)
{
	...
	if ( !(pPlayer->GetFlags() & FL_NOTARGET ) )
		ClientPrint( pPlayer, HUD_PRINTCONSOLE, "ok we good OFF\n");
	else
		ClientPrint( pPlayer, HUD_PRINTCONSOLE, "NERD!\n");
}
