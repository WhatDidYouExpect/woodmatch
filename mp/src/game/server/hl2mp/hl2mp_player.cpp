...
void CHL2MP_Player::GiveAllItems( void )
{
	...
	GiveNamedItem( "weapon_ecrowbar" );
	GiveNamedItem( "weapon_plank" );
...
//This is on spawn
//it made me cum because it was SO smooth
void CHL2MP_Player::GiveDefaultItems( void )
{
	...
	{
		Weapon_Switch( Weapon_OwnsThisType( "weapon_electriccrowbar" ) );
	}
}
...
{
	if ( Q_stristr( pModelName, "combine") )
	{
